...
static void test_cuda_tp_prefill_attn_rows_default(void) {
    ...
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
           "result-gather-dst", 1);
    CHECK(ds4_test_cuda_tp_prefill_attn_row_shadow_phase(0) == 4,
          "destination-ordered result-gather shadow phase is recognized");
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
           "result-gather-chunk16", 1);
    CHECK(ds4_test_cuda_tp_prefill_attn_row_shadow_phase(0) == 5,
          "16 MiB-chunked result-gather shadow phase is recognized");
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
    ...
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
           "result-gather-source-scratch-paced", 1);
    CHECK(ds4_test_cuda_tp_prefill_attn_row_shadow_phase(0) == 8,
          "source/destination-scratch paced result-gather phase is recognized");
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
    ...
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
           ...
           "pre-attention-paced", 1);
    CHECK(ds4_test_cuda_tp_prefill_attn_row_shadow_phase(0) == 13,
          "partner-output-scratch pre-attention gather phase is recognized");
    setenv("DS4_CUDA_TP_PREFILL_ATTN_ROW_SHADOW_PHASE",
           "result-gather-preinitialized-source-partner-output-scratch-"
