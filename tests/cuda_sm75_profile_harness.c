...
int main(int argc, char **argv) {
    ...
    const int ok = q4_moe ?
        run_moe(spec, PROFILE_TYPE_Q4_K, PROFILE_TYPE_Q4_K,
                native_q4_moe ? DS4_TENSOR_LAYOUT_SM75_NATIVE_Q4 : 0u,
                timed_repeats) :
        (q2_moe ? run_moe(spec, PROFILE_TYPE_IQ2_XXS, PROFILE_TYPE_Q2_K,
                          0u, timed_repeats) :
         (hybrid_iq2_q4_moe ?
              run_moe(spec, PROFILE_TYPE_IQ2_XXS, PROFILE_TYPE_Q4_K,
                      DS4_TENSOR_LAYOUT_SM75_NATIVE_Q4,
                      timed_repeats) :
          (sm75_q4_32_moe ?
               run_moe(spec, PROFILE_TYPE_SM75_Q4_32,
                       PROFILE_TYPE_SM75_Q4_32, private_q32_layout,
                       timed_repeats) :
           (sm75_q3a4_moe ?
                run_moe(spec, PROFILE_TYPE_SM75_Q3A4,
                        PROFILE_TYPE_SM75_Q4_32, private_q32_layout,
                        timed_repeats) :
