...
tests/cuda_decode_pair_xdev.o: tests/cuda_decode_pair_xdev.c ds4_gpu.h ds4_gpu_mgpu.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ $<

tests/cuda_decode_pair_xdev: tests/cuda_decode_pair_xdev.o ds4_cuda.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
