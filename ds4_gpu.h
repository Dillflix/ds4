...
int ds4_gpu_memory_state_write_csv(const char *path);
void ds4_gpu_q8_binding_usage_end(void);
...
int ds4_gpu_cache_q8_f16_range_on_device(const void *model_map, uint64_t model_size,
...
/* Exact SM75 persistent compressed-attention cache codec. Pack consumes the
